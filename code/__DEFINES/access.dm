...
#define ACCESS_SHIP_OFFICE (1<<1)
#define ACCESS_SHIP_COMMAND (1<<2)
#define ACCESS_SHIP_SECURITY (1<<3)
#define ACCESS_SHIP_ENGINEERING (1<<4)
#define ACCESS_SHIP_MEDICAL (1<<5)
#define ACCESS_SHIP_CARGO (1<<6)
#define ACCESS_SHIP_SERVICE (1<<7)
#define ACCESS_SHIP_SCIENCE (1<<8)
#define ACCESS_SHIP_ALL (ACCESS_SHIP_CAPTAIN | ACCESS_SHIP_OFFICE | ACCESS_SHIP_COMMAND | ACCESS_SHIP_SECURITY | ACCESS_SHIP_ENGINEERING | ACCESS_SHIP_MEDICAL | ACCESS_SHIP_CARGO | ACCESS_SHIP_SERVICE | ACCESS_SHIP_SCIENCE)
...
#define ACCESS_PAIR_ROOT list(NAMESPACE_ROOT, ACCESS_SHIP_ALL)
